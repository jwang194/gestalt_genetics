#!/bin/bash
#$ -o /u/home/j/jwang194/zp/zaitlen/gestalt/gwas/logs/gwas_dn.o$TASK_ID
#$ -e /u/home/j/jwang194/zp/zaitlen/gestalt/gwas/logs/gwas_dn.e$TASK_ID
#$ -l h_data=8G
#$ -l time=47:59:00
#$ -l highp
#$ -pe shared 4
...
PN=$(sed "${SGE_TASK_ID}q;d" /u/home/j/jwang194/zp/zaitlen/gestalt/gwas/data/phens/colnames.txt)
